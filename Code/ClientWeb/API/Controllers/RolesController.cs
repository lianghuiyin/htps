...
namespace API.Controllers
{
    public class RolesController : ApiController
    {
        ...
        public HttpResponseMessage Post(RoleWrap roleWrap)
        {
            string errMsg = "";
            string errMsgForChangeset = "";
            bool isChangesetError = false;
            Role model = roleWrap.Role;
            ...
            else
            {
                ...
                var msg = new { Role = model, Changeset = changeset, IsChangesetError = isChangesetError, ErrMsgForChangeset = errMsgForChangeset };
                json = JsonConvert.SerializeObject(msg);
            }
        ...
        public HttpResponseMessage Put(int id, RoleWrap roleWrap)
        {
            string errMsg = "";
            string errMsgForChangeset = "";
            bool isChangesetError = false;
        ...
        private bool tryDelete(string ids, out string errMsg)
        {
            ...
            if (ids != string.Empty)
            {
                if (RoleManager.DeleteRoleByIds(ids, out errMsg))
                {
                    re = true;
                }
            }
