...
namespace API.Controllers
{
    public class DepartmentsController : ApiController
    {
        ...
        public HttpResponseMessage Post(DepartmentWrap departmentWrap)
        {
            string errMsg = "";
            string errMsgForChangeset = "";
            bool isChangesetError = false;
            Department model = departmentWrap.Department;
            ...
            else
            {
                ...
                var msg = new { Department = model, Changeset = changeset, IsChangesetError = isChangesetError, ErrMsgForChangeset = errMsgForChangeset };
                json = JsonConvert.SerializeObject(msg);
            }
        ...
        public HttpResponseMessage Put(int id, DepartmentWrap departmentWrap)
        {
            string errMsg = "";
            string errMsgForChangeset = "";
            bool isChangesetError = false;
        ...
        private bool tryDelete(string ids, out string errMsg)
        {
            ...
            if (ids != string.Empty)
            {
                if (DepartmentManager.DeleteDepartmentByIds(ids, out errMsg))
                {
                    re = true;
                }
            }
