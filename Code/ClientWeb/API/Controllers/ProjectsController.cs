...
namespace API.Controllers
{
    public class ProjectsController : ApiController
    {
        ...
        public HttpResponseMessage Post(ProjectWrap projectWrap)
        {
            string errMsg = "";
            string errMsgForChangeset = "";
            bool isChangesetError = false;
            Project model = projectWrap.Project;
            ...
            else
            {
                ...
                var msg = new { Project = model, Changeset = changeset, IsChangesetError = isChangesetError, ErrMsgForChangeset = errMsgForChangeset };
                json = JsonConvert.SerializeObject(msg);
            }
        ...
        public HttpResponseMessage Put(int id, ProjectWrap projectWrap)
        {
            string errMsg = "";
            string errMsgForChangeset = "";
            bool isChangesetError = false;
        ...
        private bool tryPost(ref Model.Project model, out string errMsg)
        {
            errMsg = "";
            bool re = false;
            ...
            model.Modifier = this.auth.UserId;
            model.ModifiedDate = DateTime.Now;
            if (ProjectManager.AddProject(ref model, out errMsg))
            {
                re = true;
            }
            return re;
        ...
        private bool tryDelete(string ids, out string errMsg)
        {
            ...
            if (ids != string.Empty)
            {
                if (ProjectManager.DeleteProjectByIds(ids, out errMsg))
                {
                    re = true;
                }
            }
